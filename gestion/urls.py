...
urlpatterns = [
    ...
    path('adherents/gestion-licences/', views.gestion_licences, name='gestion_licences'),
    path('adherents/gestion-licences/export-excel/', views.export_licences_excel, name='export_licences_excel'),
    path('api/adherents/<int:adherent_id>/statut-licence/', views.api_update_statut_licence, name='api_update_statut_licence'),
    path('adherents/communiquer/', CommunicationAdherentsView.as_view(), name='adherents_communiquer'),
    path('adherents/communiquer/exporter-destinataires/', views.exporter_destinataires_adherents_excel, name='exporter_destinataires_adherents_excel'),
    ...
    path('seances/<int:seance_id>/exporter-destinataires-invitation/', views.exporter_destinataires_invitation_excel, name='exporter_destinataires_invitation_excel'),
    ...
    path('api/liste-non-adherents-actifs/', views.api_liste_non_adherents_actifs, name='api_liste_non_adherents_actifs'),
    path('api/details-non-adherent/<int:adherent_id>/', views.api_details_non_adherent, name='api_details_non_adherent'),
